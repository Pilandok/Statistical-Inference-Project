...
sample.var <- mean(rexp.data[,2])      #compute for the mean of variance
...
## The distribution of the Exponential Distribution Function


```{r}

hist(rexp(1000, .2), breaks = 100, main = "Exponential Distribution function", xlab = "Rexp(1000) values")
...
legend('topright', c("Sample Mean", "Theoretical Mean"), bty = "n", lty = c(1,1), col = c(col = 4, col = 2))
```

Above is the distribution of the means of the exponential distribution function from the dataset that was generated earlier.
